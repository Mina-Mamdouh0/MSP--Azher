...
1. **The Flutter Committee**, and it is the committee that makes many applications with different ideas and by using many programming languages ​​and libraries such as the Flutter Library

2. **The Web Committee**, which is the committee that creates websites in many different forms and ideas, using design languages ​​like HTML & CSS and others, and programming languages ​​such as JavaScript, Node JS & PHP, etc.
